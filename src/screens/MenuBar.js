...
const MenuBar = ({setIsNotifications,isNotifications}) => {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity style={styles.option} onPress={()=>{setMenuItem(1);checkIsNotifications();navigation.navigate('Home')}}>
      ...
      <TouchableOpacity style={styles.option} onPress={()=>{setMenuItem(4);checkIsNotifications();navigation.navigate('MyLearning')}}>
